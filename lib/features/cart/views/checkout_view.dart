    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CheckoutItemRow(title: "Delivery", value: "Select Method", onPressed: (){}),
           Column(
            mainAxisSize: MainAxisSize.min,
             children: [
               Padding(
                 ...
                 child: Row(
                   children: [
                     Text("Payment",style: TextStyle(color: Tcolor.secondaryText,fontSize: 18,fontWeight: FontWeight.w600),),
                     Spacer(),
                     Icon(Icons.payment,color: Tcolor.primary,size: 23,),
                ...
                Divider(color: Colors.black26,height: 1,),
                 CheckoutItemRow(title: 
                 "Total Cost", value: "Rs.80", onPressed: (){
          ...
          RoundButton(title: "Place Order", onPressed: (){
            Navigator.push(context,MaterialPageRoute(builder: (context)=>OrderAcceptView()) );
          },),
        ],
      ),
    );
