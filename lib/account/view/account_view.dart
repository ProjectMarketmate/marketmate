...
import 'package:marketmate/account/widgets/account_row.dart';
...
class _AccountViewState extends State<AccountView> {
  ...
  Widget build(BuildContext context) {
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: AssetImage("assets/images/useraccount.png"),
                  ),
                  SizedBox(width: 10,),
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          style: TextStyle(
                              ...
                              SizedBox(width: 10,),
                              IconButton(onPressed: (){}, icon: Icon(Icons.edit,color: Tcolor.primary,size: 20,))
                          ],
                        ),
                        Text(
                          "${user.email}",
    ...
    child: 
                ...
                child:Icon(Icons.logout,color: Tcolor.primary,)
                )
                  ],
                ),),
